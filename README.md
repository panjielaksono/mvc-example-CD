...
CREATE TABLE mahasiswa (id int(11) not null auto_increment primary key, nim char(14) not null, nama varchar(255) not null, created_at datetime not null, deleted_at null) -> copy dan paste ke jendela query mysql
